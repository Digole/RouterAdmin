...
export const dialUp = params => { return axios.post(`${base}/action/udialHandleAction`, params) }
...
export const DHCP = params => { return axios.post(`${base}/action/dhcpClientAction`, params) }
export const staticIP = params => { return axios.post(`${base}/action/interfaceInfoSetAction`, params) }

/*******************************************************************/
// export const getPorts = data => { return axios.post(`${base}/api/ports`, { params: data }); };
export const getPorts = data => { return axios.post(`${base}/action/interfaceMonitorAction`, data) }
...
export const getAlias = data => { return axios.post(`${base}/action/natAliasGetAction`, data) }
export const editAlias = data => { return axios.post(`${base}/action/natAliasGetAction`, data) }
export const addAlias = data => { return axios.post(`${base}/action/natAliasHandleAction`, data) }
export const delAlias = data => { return axios.post(`${base}/action/natAliasHandleAction`, data) }
export const getMapping = data => { return axios.post(`${base}/action/natMapGetAction`, data) }
export const editMapping = data => { return axios.post(`${base}/action/natMapGetAction`, data) }
export const addMapping = data => { return axios.post(`${base}/action/natMapHandleAction`, data) }
export const delMapping = data => { return axios.post(`${base}/action/natMapHandleAction`, data) }
export const sendFragment = data => { return axios.post(`${base}/action/natIpFragHandleAction`, data) }
export const getFragmentInfo = data => { return axios.post(`${base}/action/natIpFragGetAction`, data) }
export const getUsage = data => { return axios.post(`${base}/action/natAssNodeUseAction`, data) }
export const getDialStatus = data => { return axios.post(`${base}/action/netIfInfoAction`, data) }

export const sendWANLAN = data => { return axios.post(`${base}/action/natWanLanAction`, data) }

export const getQos = data => { return axios.post(`${base}/action/qosShowAction`, data) }
export const setQos = data => { return axios.post(`${base}/action/qosConfigAction`, data) }
export const delQos = data => { return axios.post(`${base}/action/qosDeleteAction`, data) }

/**********************************************************/
// export const sendSorting = data => { return axios.post(`${base}/api/intAdaHandleAction`, data);};
export const sendSorting = data => { return axios.post(`${base}/action/intAdaHandleAction`, data) }

/**********************************************************/
// export const sortingCancel = data => { return axios.post(`${base}/api/sortingCancel`, data);};
export const sortingCancel = data => { return axios.post(`${base}/action/intAdaCancelAction`, data) }

// 静态路由页面添加
export const handleRouter = data => { return axios.post(`${base}/action/routeConfigAction`, data) }
export const getRouterInfo = data => { return axios.post(`${base}/action/routeInfoGetAction`, data) }
export const addKidVpn = data => { return axios.post(`${base}/action/kidvpnHandleAction`, data) }

// VND页面的请求
export const addKidVPN = data => { return axios.post(`${base}/action/kidvpnCreateAction`, data) }
export const addVND = data => { return axios.post(`${base}/action/vndHandleAction`, data) }
export const generateAESKey = data => { return axios.post(`${base}/action/kidvpnAesKeyGenAction`, data) }
export const getAESKey = data => { return axios.post(`${base}/action/kidvpnAesKeyGetAction`, data) }
export const delKidVPN = data => { return axios.post(`${base}/action/kidvpnDelAction`, data) }
export const getKidVPNInfo = data => { return axios.post(`${base}/action/kidvpnInfoGetAction`, data) }
export const saveAESKey = data => { return axios.post(`${base}/action/kidvpnAesKeySaveAction`, data) }
export const getLinkStatus = data => { return axios.post(`${base}/action/kidvpnLinkInfoGetAction`, data) }
//  请求目的/源地址
export const getCityInfo = data => { return axios.post(`${base}/action/kidvpnPosInfoGetAction`, data) }

// VLAN页面
export const getVLAN = data => { return axios.post(`${base}/action/vlanShowAction`, data) }
export const handleVLAN = data => { return axios.post(`${base}/action/vlanConfigAction`, data) }

// 流控页面
export const getFC = data => { return axios.post(`${base}/action/flowctlShowAction`, data) }
export const handleFC = data => { return axios.post(`${base}/action/flowctlConfigAction`, data) }

// ARP绑定
export const handleARP = data => { return axios.post(`${base}/action/arpConfigAction`, data) }
export const getARP = data => { return axios.post(`${base}/action/arpShowAction`, data) }
export const getDynamicARP = data => { return axios.post(`${base}/action/arpDynamicShowAction`, data) }

// 线路监控
export const getMonitorInfo = data => { return axios.post(`${base}/action/monitorInfoGetAction`, data) }
export const handleMonitorInfo = data => { return axios.post(`${base}/action/monitorItemDisableAction`, data) }
